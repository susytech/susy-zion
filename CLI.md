...
OPTIONS:
    ...
    -d, --data-dir <PATH>                  Specify the database and configuration directory PATH.
        ...
        --susy-jsonrpc-apis <APIS>              Specify the APIs available through the JSONRPC interface. APIS is a comma-delimited list of API names.
        --susy-jsonrpc-cors <URL>               Specify CORS header for JSON-RPC API responses.
        --susy-jsonrpc-hosts <HOSTS>            List of allowed Host header values.
        --susy-jsonrpc-interface <INTERFACE>    The hostname portion of the JSONRPC API server.
        --susy-jsonrpc-port <PORT>              Specify the PORT for the JSONRPC API server.
